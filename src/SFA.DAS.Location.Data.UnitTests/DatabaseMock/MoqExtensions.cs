...
using Moq.Language.Flow;
 ...
 namespace SFA.DAS.Location.Data.UnitTests.DatabaseMock
{
    public static class MoqExtensions
    {
        ...
        public static IReturnsResult<ILocationDataContext> ReturnsDbSet<TEntity>(
            this ISetup<ILocationDataContext, DbSet<TEntity>> setupResult,
