...
{
    public class WhenGettingLocationByNameAndAuthority
    {
        [Test, MoqAutoData]
            ...
            [Greedy] LocationsController controller)
        {
            ...
            var controllerResult = await controller.GetByLocationAndAuthorityName(locationName, authorityName) as ObjectResult;
            ...
            [Greedy] LocationsController controller)
        {
            ...
            var controllerResult = await controller.GetByLocationAndAuthorityName(locationName, authorityName) as StatusCodeResult;
