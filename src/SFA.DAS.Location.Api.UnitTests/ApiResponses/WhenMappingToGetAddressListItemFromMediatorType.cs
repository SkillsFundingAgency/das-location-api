...
namespace SFA.DAS.Location.Api.UnitTests.ApiResponses
{
    public class WhenMappingToGetAddressListItemFromMediatorType
    {
        ...
        {
            var actual = (GetAddressesListItem) input;
        ...
        static object[] TestCases =
        {
            new object[]
            {
                new SuggestedAddress { Uprn = "12345", Organisation = "Organisation", Premises = "Subbuildingname, Buildingname", Thoroughfare  = "Buildingnumber Dependentthoroughfarename, Thoroughfarename", Locality = "Doubledependentlocality, Dependentlocality", PostTown = "Posttown", County = string.Empty, Postcode = "POSTCODE", Latitude = 0.00000001, Longitude = 3.00000001, Match = 0.44 },
                new GetAddressesListItem { Uprn = "12345", Organisation = "Organisation", Premises = "Subbuildingname, Buildingname", Thoroughfare = "Buildingnumber Dependentthoroughfarename, Thoroughfarename", Locality = "Doubledependentlocality, Dependentlocality", PostTown = "Posttown", County = string.Empty, Postcode = "POSTCODE", AddressLine1 = "Subbuildingname, Buildingname", AddressLine2 = "Buildingnumber Dependentthoroughfarename, Thoroughfarename", AddressLine3 = "Doubledependentlocality, Dependentlocality", Latitude = 0.00000001, Longitude = 3.00000001, Match = 0.44,  }
            },
            new object[]
            {
