...
namespace SFA.DAS.Location.Contracts.ApiResponses.V2
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class LookupPostcodeV2Response
    {
        [System.Text.Json.Serialization.JsonPropertyName("postcode")]
        [Newtonsoft.Json.JsonProperty("postcode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? Postcode { get; set; } = default!;
        ...
        [Newtonsoft.Json.JsonProperty("incode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
