namespace SFA.DAS.Location.Domain.Configuration
{
    public static class Constants
    {
        ...
        public const string OsPlacesPostCodeUrl = "https://api.os.uk/search/places/v1/postcode?postcode={0}&dataset={1}&output_srs=EPSG:4326&fq=COUNTRY_CODE:E";
        public const string OsPlacesNearestUrl = "https://api.os.uk/search/places/v1/nearest?point={0}&radius={1}&dataset={2}&srs=WGS84&lr=EN";
