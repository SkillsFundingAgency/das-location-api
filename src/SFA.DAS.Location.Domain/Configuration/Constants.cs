namespace SFA.DAS.Location.Domain.Configuration
{
    public static class Constants
    {
        ...
        public const string OsPlacesFindUrl = "https://api.os.uk/search/places/v1/find?key={0}&query={1}&dataset={2}&minmatch={3:0.0#}&matchprecision={4}&output_srs=EPSG:4326";
