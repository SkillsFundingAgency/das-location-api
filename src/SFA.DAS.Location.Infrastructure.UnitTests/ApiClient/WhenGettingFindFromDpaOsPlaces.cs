...
[TestFixture]
internal class WhenGettingFindFromDpaOsPlaces
{
    [TestCaseSource(nameof(_testCases))]
    public async Task Then_The_Endpoint_Is_Called_And_Find_Data_Returned(OsPlacesApiResponse osPlacesApiResponse, string query, double minMatch)
    {
        // Arrange
        ...
        // Act
        var actual = await osPlacesApiService.FindFromDpaOsPlaces(query, minMatch);
    ...
    public async Task Then_If_NotFound_Result_Then_Service_Returns_Null()
    {
        ...
        // Act
        var actual = await osPlacesApiService.FindFromDpaOsPlaces(query, 0.4);
    ...
    public void Then_If_It_Is_Not_Successful_An_Exception_Is_Thrown()
    {
        ...
        // Act & Assert
        Assert.ThrowsAsync<HttpRequestException>(() => osPlacesApiService.FindFromDpaOsPlaces(query, 0.4));
    }
    ...
    public void Then_If_Arguments_Are_Out_Of_Range_An_Exception_Is_Thrown()
    {
        ...
        // Act & Assert
        Assert.ThrowsAsync<ArgumentOutOfRangeException>(() => osPlacesApiService.FindFromDpaOsPlaces(query, 1.1));
    }
}
